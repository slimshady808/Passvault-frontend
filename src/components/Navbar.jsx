    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
        ...
        <div className="flex items-center">
          <button  className="mr-6 text-sm text-gray-500 dark:text-white hover:underline"> {name ? name : ''}</button>
          <button className="text-sm text-blue-600 dark:text-blue-500 hover:underline"
          onClick={name ? handleLogout : handleLogin}
          >{name ? 'logout':'login'}</button>
        </div>
      </div>
    </nav>
      ...
      <div className="max-w-screen-xl px-4 py-3 mx-auto h-8">
        <div className="flex items-center">
          <ul className="flex flex-row font-medium mt-0 mr-6 space-x-8 text-sm">
            <li>
              <button className="text-gray-900 dark:text-white hover:underline" aria-current="page"></button>
            </li>
            <li>
              <button className="text-gray-900 dark:text-white hover:underline"></button>
            </li>
            <li>
              <button className="text-gray-900 dark:text-white hover:underline"></button>
            </li>
